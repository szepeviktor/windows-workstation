...
:: Without quotes
set CHROMIUM_NAME=ungoogled-chromium
set CHROMIUM_DIR=C:\usr\ungoogled-chromium
set CHROMIUM_BIN=ungoogled-chromium.exe
...
start "%CHROMIUM_NAME%" %CHROMIUM_DIR%\%CHROMIUM_BIN% ^
    --lang=en-US ^
    --user-agent="Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0" ^
    --disk-cache-size=1 ^
    --no-proxy-server ^
