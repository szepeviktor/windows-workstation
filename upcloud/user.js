...
// $ grep '^user_pref' user.js | sed -e 's/\s\+/ /' | sort > master
// $ grep '^user_pref' ../waterfox/user.js | sed -e 's/\s\+/ /' | sort waterfox
// $ colordiff -y waterfox master
...
// Enable SSL content caching as we run on RAMDisk
user_pref("browser.cache.disk_cache_ssl", true);

// Use RAMDisk and 256 MB memory for caching
user_pref("browser.cache.disk.enable", true);
user_pref("browser.cache.memory.capacity", 262144);

// Suppress E10S notices
...
// Do not auto-start private browsing
user_pref("browser.privatebrowsing.autostart", false);

// Suppress Reader notice
user_pref("browser.reader.detectedFirstArticle", true);

// Suppress legal notice
user_pref("browser.rights.3.shown", true);

// Set deafult search engine
...
// Suppress default browser notice
user_pref("browser.shell.checkDefaultBrowser", false);
...
// Don't use auto-complete in awesomebar
user_pref("browser.urlbar.autocomplete.enabled", true);

// Display 12 rich results in awesomebar
...
// Suppress user made search suggestion notice
user_pref("browser.urlbar.userMadeSearchSuggestionsChoice", true);

// Suppress health report notice
user_pref("datareporting.healthreport.service.firstRun", true);

// Suppress data submission policy notice
...
// Prevent smooth scrolling on Home and End key presses
user_pref("general.smoothScroll.other", false);

// Text selection by double-click
...
// Send the correct Referer header
