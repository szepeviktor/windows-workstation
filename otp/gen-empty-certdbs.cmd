...
mkdir all-but-otp
bin\certutil.exe -d all-but-otp\ -N --empty-password
...
bin\certutil.exe -d all-but-otp\ -A -i www.otpbank.hu.pem -n www.otpbank.hu -t "C,,"
bin\certutil.exe -d all-but-otp\ -A -i www.otpbankdirekt.hu.pem -n www.otpbankdirekt.hu -t "C,,"

:: List all the certificates
bin\certutil.exe -d all-but-otp\ -L
