#!/usr/bin/env python
"""Get the URL of latest Adobe Flash version for Chromium under Windows 10"""
#
# VERSION       :0.1.0
...
def get_flash_url():
    """Return the URL of latest Adobe Flash version for Chromium under Windows 10"""
